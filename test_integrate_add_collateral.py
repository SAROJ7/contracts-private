...
#         super().setUp()
#         self.Addresses = {}
#         self.Addresses['Address1'] = "cxcd9c33cf4d6bccd6f5c389410dcb30d7b17e855b"
#         self.Addresses['Address2'] = "cxed01b58d1ed471a5c014175ec3bc711b250d842d"
#         self.Addresses['Address3'] = "cxe26bd62e91d7bb366f09381e5a2c56485f44910d"
...
#         print('----------------------------------------------------------------------')
#         settings = [{'name': 'Test Case 1.1', 'wAddress':'Address1', 'params' : {'_to': self._test1.get_address(),'_user_delegations':[{'_address': 'hx95248f3757afcb50efa99f529183ba401a82273c',  '_votes_in_per' : "50"},
#                                                                     {'_address': 'hxc89dfd4bf903b39ca98db905443ca9020f955e8c',  '_votes_in_per' : "100"}]}},
#                     {'name': 'Test Case 1.2', 'wAddress':'Address1', 'params' : {'_to': self._test1.get_address(),'_user_delegations':[{'_address': 'hx95248f3757afcb50efa99f529183ba401a82273c',  '_votes_in_per' : "50"},
#                                                                     {'_address': 'hxc89dfd4bf903b39ca98db905443ca9020f955e8c',  '_votes_in_per' : "100"}]}},
#                     {'name': 'Test Case 1.3', 'wAddress':'Address1', 'params' : {'_to': self._test1.get_address(),'_user_delegations':[{'_address': 'hx4917005bf4b8188b9591da520fc1c6dab8fe717f',  '_votes_in_per' : "50"},
#                                                                     {'_address': 'hx7cc2bb9d84ff3b5843f83d07818ebcff31be29e5',  '_votes_in_per' : "50"}]}},
#                     {'name': 'Test Case 1.4', 'wAddress':'Address1', 'params' : {'_to': self._test1.get_address(),'_user_delegations':[{'_address': 'hx9a24e7a53e031ab6aa7b831b1dbe4200bd3f9483',  '_votes_in_per' : "50"},
#                                                                     {'_address': 'hx8573a132f3df5c34a292fc16cb33737ffe10b367',  '_votes_in_per' : "50"}]}},
#                     {'name': 'Test Case 1.5', 'wAddress':'Address1', 'params' : {'_to': self._test1.get_address(),'_user_delegations':[{'_address': 'hx91de10325dd4b9a104c94ebc2ad9ceca279da8b6',  '_votes_in_per' : "50"},
#                                                                     {'_address': 'hx8573a132f3df5c34a292fc16cb33737ffe10b367',  '_votes_in_per' : "50"}]}},
#                     {'name': 'Test Case 1.6', 'wAddress':'Address1', 'params' : {'_to': self._test1.get_address()}},
#                     {'name': 'Test Case 2.1', 'wAddress':'Address2', 'params' : {'_to': self._test1.get_address()}},
#                     {'name': 'Test Case 2.2', 'wAddress':'Address2', 'params' : {'_to': self._test1.get_address(),'_user_delegations':[{'_address': 'hx9a24e7a53e031ab6aa7b831b1dbe4200bd3f9483',  '_votes_in_per' : "50"},
#                                                                     {'_address': 'hx8573a132f3df5c34a292fc16cb33737ffe10b367',  '_votes_in_per' : "50"}]}},
#                     {'name': 'Test Case 2.3', 'wAddress':'Address2', 'params' : {'_to': self._test1.get_address(),'_user_delegations':[{'_address': 'hx9a24e7a53e031ab6aa7b831b1dbe4200bd3f9483',  '_votes_in_per' : "50"},
#                                                                     {'_address': 'hx8573a132f3df5c34a292fc16cb33737ffe10b367',  '_votes_in_per' : "50"}]}}
#                     # {'name': 'Test Case 2.4', 'wAddress':'Address2', }
#                     ]                                                
...
#             .to(self.Addresses[sett['wAddress']]) \
#             .value (10 * 10 ** 18) \
#             .step_limit(10000000) \
#             .nid(80) \
#             .nonce(100) \
...
#             print (_tx_result)
#             if sett['name'] == 'Test Case 1.1' or sett['name'] == 'Test Case 1.2':
